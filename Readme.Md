...
Once the realm gets created please get the redirect URI, This needs to be used while configuring Okta app integration.
![Alt text](./docs/assets/KeyCloakClient.png "OIDC App")
