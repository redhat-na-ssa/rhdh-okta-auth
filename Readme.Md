...
Setup App Integration Consumer for Key Cloak. 

# Create New App Integration select type as "OIDC" 
![Alt text](./docs/assets/CreateNewAppIntegration.png "OAuth Consumer")
